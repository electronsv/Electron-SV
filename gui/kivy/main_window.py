...
from electronsv.address import Address
from electronsv.bitcoin import TYPE_ADDRESS
from electronsv import WalletStorage, Wallet
from electronsv_gui.kivy.i18n import _
from electronsv.networks import NetworkConstants
from electronsv.paymentrequest import InvoiceStore
from electronsv.util import profiler, InvalidPassword
from electronsv.plugins import run_hook
from electronsv.util import format_satoshis, format_satoshis_plain
from electronsv.paymentrequest import PR_UNPAID, PR_PAID, PR_UNKNOWN, PR_EXPIRED
...
#                 module='electronsv_gui.kivy.uix.dialogs.installwizard')
#Factory.register('InfoBubble', module='electronsv_gui.kivy.uix.dialogs')
#Factory.register('OutputList', module='electronsv_gui.kivy.uix.dialogs')
#Factory.register('OutputItem', module='electronsv_gui.kivy.uix.dialogs')
...
Factory.register('TabbedCarousel', module='electronsv_gui.kivy.uix.screens')
...
from electronsv.util import base_units
...
class ElectrumWindow(App):
    ...
    def on_qr(self, data):
        from electronsv.bitcoin import base_decode
        data = data.strip()
        ...
        from electronsv.transaction import Transaction
        from electronsv.util import bh2u
        try:
    ...
    def show_pr_details(self, req, status, is_invoice):
        from electronsv.util import format_time
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electronsv_gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electronsv_gui.kivy.uix.qrcodewidget')
