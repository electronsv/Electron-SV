...
from electronsv.util import profiler, format_time, InvalidPassword, NotEnoughFunds
from electronsv import bitcoin
from electronsv.util import timestamp_to_datetime
from electronsv.web import create_URI, parse_URI
...
class SendScreen(CScreen):
    ...
    def do_save(self):
        ...
        from electronsv.paymentrequest import make_unsigned_request, PaymentRequest
