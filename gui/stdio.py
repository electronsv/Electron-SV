...
from electronsv.util import format_satoshis, set_verbosity
from electronsv.address import Address
from electronsv.bitcoin import COIN, TYPE_ADDRESS
...
class ElectrumGui:
    ...
    def __init__(self, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print("Wallet not found. try 'electron-sv create'")
            exit()
    ...
    def network_dialog(self):
        print("use 'electron-sv setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electron-sv setconfig' to change your settings")
        return True
