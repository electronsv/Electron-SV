...
from electronsv.util import bfh, bh2u, versiontuple, UserCancelled
from electronsv.bitcoin import (b58_address_to_hash160, xpub_from_pubkey, deserialize_xpub,
                                  TYPE_ADDRESS, TYPE_SCRIPT)
from electronsv.i18n import _
from electronsv.networks import NetworkConstants
from electronsv.plugins import BasePlugin, Device
from electronsv.transaction import deserialize
from electronsv.keystore import Hardware_KeyStore, is_xpubkey, parse_xpubkey
from electronsv.address import ScriptOutput
...
class TrezorPlugin(HW_PluginBase):
    ...
    def get_tx(self, tx_hash):
        # for electron-sv previous tx is never needed, since it uses
        # bip-143 signatures.
        return None
