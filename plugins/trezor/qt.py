...
from electronsv_gui.qt.util import *
from electronsv.i18n import _
from electronsv.plugins import hook, DeviceMgr
from electronsv.util import PrintError, UserCancelled, bh2u
from electronsv.wallet import Wallet, Standard_Wallet
    ...
    def request_trezor_init_settings(self, wizard, method, model):
        ...
        if method in [TIM_NEW, TIM_RECOVER]:
            ...
            if method == TIM_MNEMONIC:
                ...
                def set_enabled():
                    from electronsv.keystore import is_xprv
    ...
    def __init__(self, window, plugin, keystore, device_id):
        ...
        def toggle_passphrase():
            ...
            if currently_enabled:
                ...
                msg = _("Your current Electron Cash wallet can only be used with "
