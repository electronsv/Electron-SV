...
from electronsv.util import bfh, bh2u
from electronsv.bitcoin import (b58_address_to_hash160, xpub_from_pubkey,
                              TYPE_ADDRESS, TYPE_SCRIPT)
from electronsv.i18n import _
from electronsv.networks import NetworkConstants
from electronsv.plugins import BasePlugin
...
class KeepKeyCompatiblePlugin(HW_PluginBase):
    ...
    def electronsv_tx_to_txtype(self, tx):
    ...
    def get_tx(self, tx_hash):
        ...
        return self.electronsv_tx_to_txtype(tx)
